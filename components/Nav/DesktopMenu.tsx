  ...
  return (
    <nav className={`${className} px-6 py-2 `}>
      <div className="hidden md:flex gap-3.5 py-2">
        <a href="#" className="font-serif text-md font-bold py-0">
          Logo
        </a>
        <a
          href="#"
          className="text-sm font-bold py-1 px-2 flex gap-0.5 md:hover:rounded-sm md:hover:h-8 md:hover:bg-gray-500 hover:text-black hover:scale-105 transform transition duration-200 ease-in-out "
        >
          benevolentartist
